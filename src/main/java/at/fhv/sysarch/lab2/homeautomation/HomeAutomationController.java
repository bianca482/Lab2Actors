...
public class HomeAutomationController extends AbstractBehavior<Void> {
    ...
    private HomeAutomationController(ActorContext<Void> context) {
        ...
        this.blinds = getContext().spawn(Blinds.create(this.blinds), "Blinds");
        ...
        ActorRef<Void> ui = getContext().spawn(UI.create(this.tempSensor, this.airCondition, this.weatherSensor, this.blinds, this.weatherSimulator, this.mediaStation), "UI");
